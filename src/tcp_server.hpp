#ifndef __STONE_TCP_SERVER_H__
#define __STONE_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(stone::IOManager* worker = stone::IOManager::GetThis()
              ,stone::IOManager* io_woker = stone::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(stone::Address::ptr addr, bool ssl = false);
...
//#ifndef __STONE_TCP_SERVER_HPP__
//#define __STONE_TCP_SERVER_HPP__
//
//#include <memory>
//#include <functional>
