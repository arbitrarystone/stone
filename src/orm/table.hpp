#ifndef __STONE_ORM_TABLE_H__
#define __STONE_ORM_TABLE_H__
...
private:
    ...
    std::string m_dbclass = "stone::IDB";
    std::string m_queryclass = "stone::IDB";
    std::string m_updateclass = "stone::IDB";
