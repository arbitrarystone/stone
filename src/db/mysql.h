#ifndef __STONE_DB_MYSQL_H__
#define __STONE_DB_MYSQL_H__
...
public:
    ...
    stone::IStmt::ptr prepare(const std::string& sql) override;
...
typedef stone::Singleton<MySQLManager> MySQLMgr;
