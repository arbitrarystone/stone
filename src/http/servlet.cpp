...
int32_t FunctionServlet::handle(stone::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    :Servlet("ServletDispatch") {
        m_default.reset(new NotFoundServlet("stone/1.0"));
    }

int32_t ServletDispatch::handle(stone::http::HttpRequest::ptr request
        , stone::http::HttpResponse::ptr response
        , stone::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(stone::http::HttpRequest::ptr request
        , stone::http::HttpResponse::ptr response
        , stone::http::HttpSession::ptr session) {
    response->setStatus(stone::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "stone/1.0.0");
