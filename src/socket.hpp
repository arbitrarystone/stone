...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(stone::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(stone::Address::ptr address);
...
//
//    static SSLSocket::ptr CreateTCP(stone::Address::ptr address);
...
//#ifndef __STONE_SOCKET_HPP__
//#define __STONE_SOCKET_HPP__
//#include <memory>
//#include "address.hpp"
//namespace stone {
